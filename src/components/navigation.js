...
render(){ return (
	<nav onClick={this.props.toggleNav} className={this.props.navIsPeeked ? "peeked" : ""} onMouseEnter={(ev)=>{this.props.navPeek(true)}} onMouseLeave={(ev)=>{this.props.navPeek(false, this.props.title)}}>
