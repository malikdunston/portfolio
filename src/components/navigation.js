...
render(){ return (
	<nav className={
		...
		<div id="circle" className={this.props.modalData.isOpen ? "modal" : ""}></div>
		...
		<svg id="logo" className={this.props.modalData.isOpen ? "modal" : ""} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30.01 29.99">
		...
		{this.props.data.open ? <ul>
			...
			<Link to="/contact">
				...
				<li onClick={this.props.openAbout}>
					<h3>About</h3>
				</li>
		</ul> : ""}
	</nav>
